...
<div class="grid grid-cols-10 mb-6">
    ...
    <div class="my-8 col-span-2 flex justify-center h-10">
        ...
        <a class="ml-2 w-auto px-2 h-10 bg-blue-400 rounded-md shadow-lg cursor-pointer flex items-center hover:bg-blue-500"
           href="{{ route('download-cv-by-id', $jobSeeker->id) }}">
            <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                 width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <p class="text-white font-bold">Sửa hồ sơ</p>
        </a>
    </div>
</div>
</body>
